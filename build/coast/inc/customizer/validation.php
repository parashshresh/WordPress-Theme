...
if ( ! function_exists( 'coast_pro_validate_long_excerpt' ) ) :
  function coast_pro_validate_long_excerpt( $validity, $value ){
	 ...
	 if ( empty( $value ) || ! is_numeric( $value ) ) {
		 $validity->add( 'required', esc_html__( 'You must supply a valid number.', 'coast' ) );
	 } elseif ( $value < 5 ) {
		 $validity->add( 'min_no_of_words', esc_html__( 'Minimum no of words is 5', 'coast' ) );
	 } elseif ( $value > 100 ) {
		 $validity->add( 'max_no_of_words', esc_html__( 'Maximum no of words is 100', 'coast' ) );
	 }
	 return $validity;
  }
endif;
...
if ( ! function_exists( 'coast_pro_validate_slider_count' ) ) :
  function coast_pro_validate_slider_count( $validity, $value ){
	 ...
	 if ( empty( $value ) || ! is_numeric( $value ) ) {
		 ...
		 $validity->add( 'min_no_of_posts', esc_html__( 'Minimum no of posts is 1', 'coast' ) );
	 } elseif ( $value > 10 ) {
		 $validity->add( 'max_no_of_posts', esc_html__( 'Maximum no of posts is 10', 'coast' ) );
	 }
	 return $validity;
  }
endif;
...
if ( ! function_exists( 'coast_pro_validate_featured_count' ) ) :
  function coast_pro_validate_featured_count( $validity, $value ){
	 ...
	 if ( empty( $value ) || ! is_numeric( $value ) ) {
		 ...
		 $validity->add( 'min_no_of_posts', esc_html__( 'Minimum no of posts is 3', 'coast' ) );
	 } elseif ( $value > 12 ) {
		 $validity->add( 'max_no_of_posts', esc_html__( 'Maximum no of posts is 12', 'coast' ) );
	 }
	 return $validity;
  }
endif;
...
if ( ! function_exists( 'coast_pro_validate_blog_count' ) ) :
  function coast_pro_validate_blog_count( $validity, $value ){
	 ...
	 if ( empty( $value ) || ! is_numeric( $value ) ) {
		 ...
		 $validity->add( 'min_no_of_posts', esc_html__( 'Minimum no of posts is 2', 'coast' ) );
	 } elseif ( $value > 12 ) {
		 $validity->add( 'max_no_of_posts', esc_html__( 'Maximum no of posts is 12', 'coast' ) );
	 }
	 return $validity;
...
if ( ! function_exists( 'coast_pro_validate_popular_product_count' ) ) :
  function coast_pro_validate_popular_product_count( $validity, $value ){
	 ...
	 if ( empty( $value ) || ! is_numeric( $value ) ) {
		 ...
		 $validity->add( 'min_no_of_posts', esc_html__( 'Minimum no of posts is 4', 'coast' ) );
	 } elseif ( $value > 12 ) {
		 $validity->add( 'max_no_of_posts', esc_html__( 'Maximum no of posts is 12', 'coast' ) );
	 }
	 return $validity;
