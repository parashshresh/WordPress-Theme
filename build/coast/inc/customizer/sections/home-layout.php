...
$wp_customize->add_section( 'coast_pro_home_layout', array(
	'title'             => esc_html__( 'Home Page Layout','coast' ),
	'description'       => esc_html__( 'Home Page Layout option.', 'coast' ),
...
$wp_customize->add_control( new Coast_Pro_Customize_Sortable_Control ( $wp_customize, 'coast_pro_theme_options[default_sortable]', array(
	'label'               => esc_html__( 'Sortable Homepage', 'coast' ),
	'description'         => esc_html__( 'Drag and Drop to sort the sections according to your preference.', 'coast' ),
