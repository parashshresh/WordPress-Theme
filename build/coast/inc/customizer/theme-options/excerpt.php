...
$wp_customize->add_section( 'coast_pro_excerpt_section', array(
	'title'             => esc_html__( 'Excerpt','coast' ),
	'description'       => esc_html__( 'Excerpt section options.', 'coast' ),
...
$wp_customize->add_control( 'coast_pro_theme_options[long_excerpt_length]', array(
	'label'       		=> esc_html__( 'Blog Page Excerpt Length', 'coast' ),
	'description' 		=> esc_html__( 'Total words to be displayed in archive page/search page.', 'coast' ),
