...
$wp_customize->add_section( 'coast_pro_reset_section', array(
	'title'             => esc_html__('Reset all settings','coast'),
	'description'       => esc_html__( 'Caution: All settings will be reset to default. Refresh the page after clicking Save & Publish.', 'coast' ),
) );
...
$wp_customize->add_control( 'coast_pro_theme_options[reset_options]', array(
	'label'             => esc_html__( 'Check to reset all settings', 'coast' ),
