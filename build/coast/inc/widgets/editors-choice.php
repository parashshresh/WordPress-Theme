    ...
    class Coast_Pro_Editors_Choice extends WP_Widget {
        ...
        public function __construct() {
            $tp_widget_editors_choice = array(
                ...
                'description' => esc_html__( 'Retrive Editors Choice.', 'coast' ),
            );
            $this->default_title = __( 'Top Posts &amp; Pages', 'coast' );

            parent::__construct( 'coast_pro_editors_choice', esc_html__( 'TP : Editors Choice', 'coast' ), $tp_widget_editors_choice );
        ...
        public static function defaults() {
            return array(
                'title'    => esc_html__( 'Editor Choice ', 'coast' ),
                'count'    => absint( 4 ),
                'types'    => 'post',
                'category'  => '',
