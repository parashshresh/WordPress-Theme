    ...
    class Coast_Pro_Popular_Post extends WP_Widget {
        ...
        public function __construct() {
            $tp_widget_popular_post = array(
                ...
                'description' => esc_html__( 'Retrive Popular posts.', 'coast' ),
            );
            $this->default_title = __( 'Top Posts &amp; Pages', 'coast' );

            parent::__construct( 'coast_pro_popular_post', esc_html__( 'TP : Popular Posts', 'coast' ), $tp_widget_popular_post );
        ...
        function form( $instance ) {
            ...
            ?>
            <p>
                <label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php esc_html_e( 'Title:', 'coast' ); ?></label>
                <input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
            </p>
    
            <p>
                <label for="<?php echo $this->get_field_id( 'count' ); ?>"><?php esc_html_e( 'Maximum number of posts to show (no more than 10):', 'coast' ); ?></label>
            ...
            <p id="select-category">
                <label for="<?php echo esc_attr( $this->get_field_id( 'category' ) ); ?>"><?php esc_html_e( 'Select the category to show posts:', 'coast' ); ?></label>
            ...
            <hr>
            <p>
                <label><?php esc_html_e( 'Sort By:', 'coast' ); ?></label>
                <ul>
                    <li>
                        <label>
                            ...
                            <?php esc_html_e( 'Published Date', 'coast' ); ?>
                        </label>
                    </li>
                    <li>
                        <label>
                            ...
                            <?php esc_html_e( 'Alphabetical ', 'coast' ); ?>
                        </label>
                    </li>
                </ul>
            </p>
        ...
        public static function defaults() {
            return array(
                'title'    => esc_html__( 'Popular Posts ', 'coast' ),
                'count'    => absint( 4 ),
                'types'    => 'post',
                'ordering' => 'date',
                'category'  => '',
