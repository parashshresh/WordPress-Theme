...
if ( ! function_exists( 'coast_pro_setup' ) ) :
	...
	function coast_pro_setup() {
		...
		add_theme_support( 'editor-color-palette', array(
	       	array(
				'name' => esc_html__( 'Blue', 'coast' ),
				'slug' => 'blue',
				'color' => '#2c7dfa',
	       	),
	       	array(
	           	'name' => esc_html__( 'Green', 'coast' ),
	           	'slug' => 'green',
	           	'color' => '#07d79c',
	       	),
	       	array(
	           	'name' => esc_html__( 'Orange', 'coast' ),
	           	'slug' => 'orange',
	           	'color' => '#ff8737',
	       	),
	       	array(
	           	'name' => esc_html__( 'Black', 'coast' ),
	           	'slug' => 'black',
	           	'color' => '#2f3633',
	       	),
	       	array(
	           	'name' => esc_html__( 'Grey', 'coast' ),
	           	'slug' => 'grey',
	           	'color' => '#82868b',
	       	),
	   	));
		...
		add_theme_support( 'editor-font-sizes', array(
		   	array(
		       	'name' => esc_html__( 'small', 'coast' ),
		       	'shortName' => esc_html__( 'S', 'coast' ),
		       	'size' => 12,
		       	'slug' => 'small'
		   	),
		   	array(
		       	'name' => esc_html__( 'regular', 'coast' ),
		       	'shortName' => esc_html__( 'M', 'coast' ),
		       	'size' => 16,
		       	'slug' => 'regular'
		   	),
		   	array(
		       	'name' => esc_html__( 'larger', 'coast' ),
		       	'shortName' => esc_html__( 'L', 'coast' ),
		       	'size' => 36,
		       	'slug' => 'larger'
		   	),
		   	array(
		       	'name' => esc_html__( 'huge', 'coast' ),
		       	'shortName' => esc_html__( 'XL', 'coast' ),
		       	'size' => 48,
		       	'slug' => 'huge'
		   	)
		));
...
function coast_pro_widgets_init() {
	register_sidebar( array(
		...
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'coast' ),
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Homepage Sidebar', 'coast' ),
		'id'            => 'homepage-sidebar',
		'description'   => esc_html__( 'Add widgets here.', 'coast' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Single Trip Sidebar', 'coast' ),
	...
	register_sidebars( 4, array(
		'name'          => esc_html__( 'Optional Sidebar %d', 'coast' ),
		'id'            => 'optional-sidebar',
		'description'   => esc_html__( 'Add widgets here.', 'coast' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
...
function coast_pro_fonts_url() {
	...
	if ( 'off' !== _x( 'on', 'Arima font: on or off', 'coast' ) ) {
		$fonts[] = 'Arima:400,600,700';
	}

	if ( 'off' !== _x( 'on', 'Lato font: on or off', 'coast' ) ) {
		$fonts[] = 'Lato:400,700';
	}
...
function coast_pro_scripts() {
	...
	$coast_pro_l10n = array(
		...
		'expand'         => esc_html__( 'Expand child menu', 'coast' ),
		'collapse'       => esc_html__( 'Collapse child menu', 'coast' ),
