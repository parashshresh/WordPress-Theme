...
function coast_pro_ctdi_plugin_page_setup( $default_settings ) {
    $default_settings['menu_title']  = esc_html__( 'Theme Palace Demo Import' , 'coast-pro' );
...
function coast_pro_ctdi_import_files() {
    return array(
        ...
        array(
            'import_file_name'             => esc_html__( 'Dark', 'coast-pro' ),
            'categories'                   => array( ),
            ...
            'import_notice'                => esc_html__( 'Please wait for a few minutes, do not close the window or refresh the page until the data is imported.', 'coast-pro' ),
            'preview_url'                  => 'https://themepalacedemo.com/coast-dark',
        ),

        array(
            'import_file_name'             => esc_html__( 'Pro', 'coast-pro' ),
            'categories'                   => array( ),
        ...
        array(
            'import_file_name'             => esc_html__( 'Blog', 'coast-pro' ),
            'categories'                   => array( ),
        ...
        array(
            'import_file_name'             => esc_html__( 'medical', 'coast-pro' ),
            'categories'                   => array( ),
        ...
        array(
            'import_file_name'             => esc_html__( 'Shop', 'coast-pro' ),
            'categories'                   => array( ),
