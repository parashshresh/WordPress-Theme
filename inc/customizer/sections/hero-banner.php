...
$wp_customize->add_section('coast_pro_hero_banner_section', array(
	'title'             => esc_html__('Hero Banner', 'coast-pro'),
	'description'       => esc_html__('Hero Banner Section options.', 'coast-pro'),
...
$wp_customize->add_control(new Coast_Pro_Switch_Control($wp_customize, 'coast_pro_theme_options[hero_banner_section_enable]', array(
	'label'             => esc_html__('Hero Banner Section Enable', 'coast-pro'),
...
$wp_customize->add_control(new WP_Customize_Image_Control(
	...
	array(
		'label'       		=> esc_html__('Background Image ', 'coast-pro'),
		'description' 		=> sprintf(esc_html__('Recommended size: %1$dpx x %2$dpx ', 'coast-pro'), 1000, 1280),
		'section'     		=> 'coast_pro_hero_banner_section',
...
$wp_customize->add_control('coast_pro_theme_options[hero_banner_content]', array(
	'label'           	=> esc_html__('Section Content', 'coast-pro'),
	'section'        	=> 'coast_pro_hero_banner_section',
	'active_callback' 	=> 'coast_pro_is_hero_banner_section_enable',
	'type'				=> 'textarea',
));
...
$wp_customize->add_control('coast_pro_theme_options[hero_banner_btn_label]', array(
	'label'           	=> esc_html__('Btn Label', 'coast-pro'),
	'section'        	=> 'coast_pro_hero_banner_section',
	'active_callback' 	=> 'coast_pro_is_hero_banner_section_enable',
	'type'				=> 'text',
));
...
$wp_customize->add_control(
	...
	array(
		'section'			=> 'coast_pro_hero_banner_section',
		'label'				=> esc_html__('Button URL', 'coast-pro'),
		'type'          	=> 'text',
		'active_callback'	=> 'coast_pro_is_hero_banner_section_enable',
	)
);
...
$wp_customize->add_control(
	...
	array(
		'section'			=> 'coast_pro_hero_banner_section',
		'label'				=> esc_html__('Play Video Button URL', 'coast-pro'),
		'type'          	=> 'text',
		'active_callback'	=> 'coast_pro_is_hero_banner_section_enable',
	)
);
