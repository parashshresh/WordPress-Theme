 ...
 */
class Coast_Pro_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Coast_Pro_Dropdown_Category_Control extends WP_Customize_Control {
...
class Coast_Pro_Note_Control extends WP_Customize_Control {
...
class Coast_Pro_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class Coast_Pro_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="coast-pro-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 */
class Coast_Pro_Custom_Radio_Image_Control extends WP_Customize_Control {
...
class Coast_Pro_Customize_Sortable_Control extends WP_Customize_Control {
  ...
  public function render_content() {
    ...
    <ul class="coast-pro-sortable-list">
      ...
      ?>
        ...
        <li>
            <input class="coast-pro-sortable-input sortable-hideme" name="<?php echo esc_attr( $value ); ?> " type="hidden"  value="<?php echo esc_attr( $value ); ?>" />
            <span class ="menu-item-handle sortable-span"> <?php echo esc_attr( $choices[$value] ); ?> </span>
          <i class="dashicons dashicons-menu coast-pro-drag-handle"></i>
        </li>
        ...
        <li class="sortable-hideme">
          <input class="coast-pro-sortable-value" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
        </li>
...
class Coast_Pro_Icon_Picker extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
	            ...
	            <?php } ?>
	            <input id="coast-pro-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'coast-pro' ); ?>" class="coast-pro-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
...
class Coast_Pro_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
 ...
 * @since  1.0.0
 */
class Coast_Pro_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
