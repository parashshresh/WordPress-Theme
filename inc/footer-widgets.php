...
class Coast_Pro_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'coast_pro';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'coast-pro' ), $i ),
...
// Initialize.
$coast_pro_footer_widgets = new Coast_Pro_Footer_Widgets();
