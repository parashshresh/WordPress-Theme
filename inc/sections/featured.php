        ...
        <div id="coast-interest" class="relative <?php echo esc_attr($section_class); ?>">
            <div class="wrapper">
                ...
                <div class="section-content">
                    <p><?php echo isset($options['featured_sub_title']) && !empty($options['featured_sub_title']) ? esc_html($options['featured_sub_title']) : __( 'Know More', 'coast-pro' ); ?></p>
                </div><!-- .section-content -->
                            ...
                            <div class="entry-container">
                                ...
                                <?php if (!empty($content['count'])) : ?>
                                    <span class="featured-description">
                                        <?php echo sprintf('<p>%d&nbsp;%s</p>', esc_html($content['count']), __('Packages', 'coast-pro')); ?> </p>
                                    </span>
                                <?php endif ?>
                            </div>
